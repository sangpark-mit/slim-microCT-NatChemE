...
ExpImage_t1=imread('D1_0900.tif');
ExpImage_t2=imread('D1_1000.tif');
ExpImage_t3=imread('D1_1100.tif');
...
CroppedArea1 = [625 1100 200 200]; % For C
CroppedArea2 = [1000 1100 200 200]; % For C
CroppedArea3 = [925 900 200 200]; % For C
%------------
figure (11)
imshow(ExpImage_t1)
...
threshold1 = 10500; % For C
threshold2 = 11000; % For C
threshold3 = 10800; % For C
