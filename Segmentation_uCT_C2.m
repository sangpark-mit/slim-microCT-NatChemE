...
ExpImage_t1=imread('C2_0900.tif');
ExpImage_t2=imread('C2_1000.tif');
ExpImage_t3=imread('C2_1100.tif');
...
CroppedArea1 = [900 1000 200 200]; % For C
CroppedArea2 = [1100 825 200 200]; % For C
CroppedArea3 = [1150 925 200 200]; % For C
%------------
figure (11)
imshow(ExpImage_t1)
...
threshold1 = 8300; % For C
threshold2 = 8300; % For C
threshold3 = 8300; % For C
